...
const templates = [
  ...
  },
  {
    ...
    preview: "/placeholder.svg?height=400&width=300",
    features: ["Executive styling", "Premium look", "Leadership focused"],
  },
  {
    id: "tech" as const,
    name: "Tech",
    ...
    preview: "/placeholder.svg?height=400&width=300",
    features: ["Tech-focused", "Code-friendly", "Modern aesthetics"],
  },
  {
  ...
  },
  {
    ...
    name: "Designer",
    description: "Creative showcase for design professionals",
    preview: "/placeholder.svg?height=400&width=300",
    features: ["Portfolio style", "Visual emphasis", "Creative layout"],
  },
]
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-auto">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-8 py-6 flex items-center justify-between rounded-t-2xl">
          <div>
            ...
            <p className="text-slate-600 mt-1">Select a design that matches your style and profession</p>
          </div>
